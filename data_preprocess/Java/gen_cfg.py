...
# def data2java(dataset_file, java_dir):  # json format
...
def data2java(dataset_file, java_dir):  # txt
    file = open(dataset_file, encoding='utf-8')
    i = 0
    for line in file.readlines():
        i += 1
...
def process_cfg_2(cfg_dir, java_dir, final_cfg_dir):  # 按列取源代码
    cfg_file_list = os.listdir(cfg_dir)
    os.chdir(cfg_dir)
    for item in tqdm(cfg_file_list):
        if item.find('.txt') > 0:
...
def clean_dataset(dataset_file, new_file, cfg_dir):  # json数据集清洗
    cfg_file_list = os.listdir(cfg_dir)
...
if __name__ == '__main__':
    data2java(dataset_file='Java/test/test.source',
                java_dir='java_files/')
    # process_cfg(cfg_dir='E:\\dataset\\code comment\\new_dataset\\train\\cfgs\\',
    #             java_dir='E:\\dataset\\code comment\\new_dataset\\train\\java_files\\',
    #             final_cfg_dir='E:\\dataset\\code comment\\new_dataset\\train\\final_cfgs\\')
    # clean_dataset(dataset_file='C:\\Users\\zzz\\Desktop\\code comment\\code_comment_train_final_graph.json',
    #               new_file='C:\\Users\\zzz\\Desktop\\cfgs\\clean_train_set.json',
    #               cfg_dir='C:\\Users\\zzz\\Desktop\\cfgs\\train_cfg\\')
    # clean_dataset_2(origin_dir='E:\\dataset\\code comment\\cfg_40w\\train\\origin\\',
    #                 origin_clean_dir='E:\\dataset\\code comment\\cfg_40w\\train\\origin_clean\\',
    #                 code_split_dir='E:\\dataset\\code comment\\cfg_40w\\train\\code_split\\',
    #                 batch_type='train')
    # add_head(code_split_dir='E:\\dataset\\code comment\\cfg_40w\\train\\code_split\\',
    #          source_path='E:\\dataset\\code comment\\cfg_40w\\train\\origin\\train.source',
    #          new_split_path='E:\\dataset\\code comment\\cfg_40w\\train\\origin_clean\\split_train.txt')
