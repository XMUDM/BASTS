...
#     ref = 'ast_output_ep5_relu_gpu3.txt'
#     output = 'clean_test_nl.txt'
#     workbook = xlwt.Workbook(encoding='utf-8')  # 新建工作簿
#     sheet1 = workbook.add_sheet("test", cell_overwrite_ok=True)  # 新建sheet
#     sheet1.write(0, 0, "epoch")  # 第1行第1列数据
#     sheet1.write(0, 1, "ROUGE-1")  # 第1行第2列数据
#     sheet1.write(0, 2, "ROUGE-2")
#     sheet1.write(0, 3, "ROUGE-L")
#
#     # sheet1.write(1, 0, "张三")  # 第2行第1列数据
#     # sheet1.write(1, 1, "036")  # 第2行第2列数据
#
#     flag = 1
#     for epoch in tqdm(range(0, 101, 5)):
#         if epoch == 0:
#             epoch = 1
#         ref = 'files_relu_gpu3_ep100/ast_output_ep' + str(epoch) + '_relu_gpu3.txt'
#         # ref = 'ast_output_ep5_relu_gpu3.txt'
...
#
#         avg_rouge_1, avg_rouge_2, avg_rouge_l = avg_rouge(gen, ref)
#         sheet1.write(flag, 0, epoch)
#         sheet1.write(flag, 1, float(avg_rouge_1[2]) * 100)
#         sheet1.write(flag, 2, float(avg_rouge_2[2]) * 100)
#         sheet1.write(flag, 3, float(avg_rouge_l[2]) * 100)
#         flag += 1
#     workbook.save('ast_ep1-100_rouge.xls')  # 保存
#     print("save!!!")
